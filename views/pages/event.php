...
<?php endif;?>
                  ...
                  <div id="qrcode"><?php echo HTML::QRCode($qr_text, $anons_config['allow_qr']);?></div>                 
                        ...
                        <?php if($item->price):?>
                          <p class="titl">Цена:</p>
                          <P><?php echo $item->price?> <?php echo (!in_array($item->price, array('Вход свободный', 'уточняйте у организаторов', 'Уточняйте у организаторов', 'Уточняйте дополнительно', '50 коп./мин первого часа, а последующие по 25 коп.'))) ? 'грн.' : '';?></p>
                        <?php endif;?>
