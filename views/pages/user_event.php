				...
				<form action="/users/add" method="post" id="addEvent" enctype="multipart/form-data">
					<div class="row1">
						<div class="my_event_add">
							...
							<span class="default"><?php echo $event->title?></span>
					...
					<div class="row1-1">
						...
						<div class="my_event_add">
							...
							<input type="text" class="bind_input" name="price" id="price" value="<?php echo $event->price?>" />
							<div class="clear"></div>
					...
					<div class="row2">
						<div class="my_event_add">
							...
							<table class="admintable">
								<tbody><tr>
									<?php if($event->type == 1): ?>
									<?php $dateitems = explode(' ', $event->date);
